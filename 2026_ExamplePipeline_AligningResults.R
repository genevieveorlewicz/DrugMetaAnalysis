...
ListOfMouseDEResults<-list(`DEResults_GSE43410 - m _529724`, DEResults_GSE18751_516219, `DEResults_GSE63748 - m_536281`, `DEResults_GSE9134 - m _560143`, `DEResults_GSE76868 - m_550679`, `DEResults_GSE276453 - m_590389`, `DEResults_GSE141520 - m _642255`, `DEResults_GSE110344 - m _492906`, `DEResults_GSE110344 - m _492906`)
...
ListOfRatDEResults<-list(`DEResults_GSE169665 - r_579445`, `DEResults_GSE66349 - r_524663`, `DEResults_GSE169666 - r_578302`, `DEResults_GSE88736 - r_512558`)
...
FixedColNames<-read.csv("MouseRatColNames - Colnames_MetaAnalysisFoldChanges.csv", header=TRUE, stringsAsFactors=FALSE)
str(FixedColNames)


colnames(MetaAnalysis_FoldChanges)<-FixedColNames$x
...
plot(MetaAnalysis_FoldChanges$GSE18751_cocaine_dose.7.x.20.mg.kg_1.x.20.mg.kg
       ~MetaAnalysis_FoldChanges$GSE18751_cocaine_dose_1.x.20.mg.kg)
